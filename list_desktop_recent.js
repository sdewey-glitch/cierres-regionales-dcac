        ...
        for (const file of files) {
            ...
            if (stat.isDirectory()) {
                ...
                if (stat.mtime > thresholdDate) {
                    console.log(`Desktop Modified: ${fullPath} | Size: ${stat.size} bytes | MTime: ${stat.mtime}`);
                }
            }
        }
    } catch(e) {}
...
console.log("Searching for recently modified files on Desktop...");
searchDir(desktopDir);
