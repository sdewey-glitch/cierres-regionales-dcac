...
exports.listDriveFolders = listDriveFolders;
exports.listDriveFiles = listDriveFiles;
exports.getCierreLinks = getCierreLinks;
exports.getOrCreateYearFolder = getOrCreateYearFolder;
exports.getOrCreateMonthFolder = getOrCreateMonthFolder;
...
async function uploadPdfToDrive(folderId, fileName, pdfBuffer) {
    ...
    const fileRes = await drive.files.create({
        ...
        media: {
            mimeType: 'application/pdf',
            body: stream_1.Readable.from(pdfBuffer),
        },
